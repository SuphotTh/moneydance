...
@login_required
@csrf_exempt
def convert_moneydance(request): #for Dialy Update
    if request.method == 'GET':
        ...
        try:
            ...
            filter_condition = {'date__gte': f'{last_year}-01-01'}
...
@login_required
@csrf_exempt
def convert_moneydanceXXX(request): # for First Entering Data to Database
