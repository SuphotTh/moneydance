...
#                 if backend_table == 'category':
#                     if table_name == 'income':
#                         fetched_data = Category.objects.filter(group="Income").values()
#                     elif table_name == 'expenses':
#                         fetched_data = Category.objects.filter(group="Expenses").values()
#                 elif backend_table == 'payee':
#                     fetched_data = Payee.objects.all().values()
#                 elif backend_table == 'account_type':
#                     fetched_data = Account_type.objects.all().values()
#                 elif backend_table == 'account_name':
#                     fetched_data = Account_name.objects.all().values()
#                 return JsonResponse(list(fetched_data), safe=False)
#             except json.JSONDecodeError:
...
#     fetched_data = [{"id": 1, "name": "Example 1"}, {"id": 2, "name": "Example 2"}]
#     return render(request, 'settings.html')
