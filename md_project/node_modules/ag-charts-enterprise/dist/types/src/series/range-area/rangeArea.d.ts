...
type ItemStyle = Required<FillOptions & StrokeOptions & {
    size: number;
}>;
export declare class RangeAreaSeries extends _ModuleSupport.CartesianSeries<_ModuleSupport.Group, RangeAreaProperties, RangeAreaMarkerDatum, RangeAreaLabelDatum, RangeAreaContext> {
    ...
    protected markerFactory(): _ModuleSupport.Marker;
    ...
    }): _ModuleSupport.Selection<_ModuleSupport.Text, RangeAreaLabelDatum>;
    ...
    getTooltipContent(nodeDatum: RangeAreaMarkerDatum): _ModuleSupport.TooltipContent | string | undefined;
    private legendItemSymbol;
    getLegendData(legendType: _ModuleSupport.ChartLegendType): _ModuleSupport.CategoryLegendDatum[];
    protected isLabelEnabled(): boolean;
    onDataChange(): void;
    protected nodeFactory(): _ModuleSupport.Group;
    ...
    protected computeFocusDatumIndex(opts: _ModuleSupport.PickFocusInputs, nodeData: RangeAreaMarkerDatum[]): number | undefined;
}
export {};
