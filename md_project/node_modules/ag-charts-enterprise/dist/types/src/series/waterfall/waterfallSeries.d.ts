...
export declare class WaterfallSeries extends _ModuleSupport.AbstractBarSeries<_ModuleSupport.Rect, WaterfallSeriesProperties, WaterfallNodeDatum, WaterfallNodeDatum, WaterfallContext> {
    ...
    }): _ModuleSupport.Selection<_ModuleSupport.Rect, WaterfallNodeDatum>;
    ...
    }): _ModuleSupport.Selection<_ModuleSupport.Text, WaterfallNodeDatum>;
    protected updateLabelNodes(opts: {
        labelSelection: _ModuleSupport.Selection<_ModuleSupport.Text, WaterfallNodeDatum>;
    }): void;
    getTooltipContent(nodeDatum: WaterfallNodeDatum): _ModuleSupport.TooltipContent | string | undefined;
    ...
    protected animateConnectorLinesHorizontal(lineNode: _ModuleSupport.Path, pointData: WaterfallNodePointDatum[]): void;
    protected animateConnectorLinesVertical(lineNode: _ModuleSupport.Path, pointData: WaterfallNodePointDatum[]): void;
