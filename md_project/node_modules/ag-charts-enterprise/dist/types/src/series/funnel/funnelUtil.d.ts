...
export declare function prepareConnectorAnimationFunctions<T extends AnimatableConnectorDatum>(isVertical: boolean, mode: 'normal' | 'fade'): {
    fromFn: _ModuleSupport.FromToMotionPropFn<FunnelConnector, AnimatableConnectorDatum, T>;
    toFn: _ModuleSupport.FromToMotionPropFn<FunnelConnector, AnimatableConnectorDatum, T>;
};
