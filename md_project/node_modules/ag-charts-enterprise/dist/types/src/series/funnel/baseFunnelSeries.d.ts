...
export declare abstract class BaseFunnelSeries<TNode extends _ModuleSupport.QuadtreeCompatibleNode> extends _ModuleSupport.AbstractBarSeries<TNode, BaseFunnelProperties<any>, FunnelNodeDatum, FunnelNodeLabelDatum, FunnelContext> {
    ...
    protected readonly connectorNodeGroup: _ModuleSupport.Group;
    protected connectorSelection: _ModuleSupport.Selection<FunnelConnector, FunnelConnectorDatum>;
    ...
    }): _ModuleSupport.Selection<_ModuleSupport.Text, FunnelNodeLabelDatum>;
    protected updateLabelNodes(opts: {
        labelSelection: _ModuleSupport.Selection<_ModuleSupport.Text>;
    }): void;
    getTooltipContent(nodeDatum: FunnelNodeDatum): _ModuleSupport.TooltipContent | string | undefined;
