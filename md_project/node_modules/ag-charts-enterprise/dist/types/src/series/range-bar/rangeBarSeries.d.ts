...
export declare class RangeBarSeries extends _ModuleSupport.AbstractBarSeries<_ModuleSupport.Rect, RangeBarProperties, RangeBarNodeDatum, RangeBarNodeLabelDatum> {
    ...
    }): _ModuleSupport.Selection<_ModuleSupport.Rect, RangeBarNodeDatum>;
    ...
    }): _ModuleSupport.Selection<_ModuleSupport.Text, RangeBarNodeLabelDatum>;
    protected updateLabelNodes(opts: {
        labelSelection: _ModuleSupport.Selection<_ModuleSupport.Text>;
    }): void;
    getTooltipContent(nodeDatum: RangeBarNodeDatum): _ModuleSupport.TooltipContent | string | undefined;
