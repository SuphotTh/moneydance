...
export declare function prepareLinearGaugeSeriesAnimationFunctions(initialLoad: boolean, horizontal: boolean): {
    node: _ModuleSupport.FromToFns<_ModuleSupport.Rect, RectAnimationParams, AnimatableRectDatum>;
};
...
export declare function formatLinearGaugeLabels(series: _ModuleSupport.Series<any, any>, selection: _ModuleSupport.Selection<_ModuleSupport.Text, LinearGaugeLabelDatum>, opts: {
    padding: number;
    horizontal: boolean;
}, bboxes: {
    scale: _ModuleSupport.BBox;
    bar: _ModuleSupport.BBox;
}, datumOverrides?: {
