...
export declare abstract class OhlcSeriesBase<TNode extends OhlcBaseNode, TSeriesOptions extends OhlcSeriesBaseProperties<any>> extends _ModuleSupport.AbstractBarSeries<TNode, TSeriesOptions, OhlcNodeDatum> {
    ...
    getSeriesRange(_direction: _ModuleSupport.ChartAxisDirection, visibleRange: [any, any]): [number, number];
    createNodeData(): {
        itemId: string;
    ...
    protected updateLabelSelection(opts: {
        ...
        labelSelection: _ModuleSupport.Selection<_ModuleSupport.Text, OhlcNodeDatum>;
        seriesIdx: number;
    }): _ModuleSupport.Selection<_ModuleSupport.Text, OhlcNodeDatum>;
    protected getItemBaseStyle(itemId: 'up' | 'down', highlighted: boolean): _ModuleSupport.RequireOptional<FillOptions & StrokeOptions & LineDashOptions>;
    protected getItemStyleOverrides(datumId: string, datum: any, itemId: 'up' | 'down', format: _ModuleSupport.RequireOptional<FillOptions & StrokeOptions & LineDashOptions>, highlighted: boolean): import("ag-charts-community").AgOhlcSeriesItemOptions | undefined;
    getTooltipContent(nodeDatum: OhlcNodeDatum): _ModuleSupport.TooltipContent | string | undefined;
