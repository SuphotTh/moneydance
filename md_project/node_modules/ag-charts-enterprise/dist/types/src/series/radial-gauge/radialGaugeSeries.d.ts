...
export declare class RadialGaugeSeries extends _ModuleSupport.Series<RadialGaugeNodeDatum, RadialGaugeSeriesProperties, RadialGaugeLabelDatum, RadialGaugeNodeDataContext> implements _ModuleSupport.RadialGaugeSeries {
    ...
    get maximumRadius(): number | undefined;
    ...
    pickNode(point: _ModuleSupport.Point, intent: _ModuleSupport.SeriesNodePickIntent): _ModuleSupport.PickResult | undefined;
    getTooltipContent(nodeDatum: _ModuleSupport.SeriesNodeDatum): _ModuleSupport.TooltipContent | string | undefined;
