...
export declare function prepareRadialGaugeSeriesAnimationFunctions(initialLoad: boolean, initialStartAngle: number): {
    node: _ModuleSupport.FromToFns<_ModuleSupport.Sector, SectorAnimation, AnimatableSectorDatum>;
...
export declare function formatRadialGaugeLabels(series: _ModuleSupport.Series<any, any>, selection: _ModuleSupport.Selection<_ModuleSupport.Text, RadialGaugeLabelDatum>, opts: {
    padding: number;
    textAlign: TextAlign;
