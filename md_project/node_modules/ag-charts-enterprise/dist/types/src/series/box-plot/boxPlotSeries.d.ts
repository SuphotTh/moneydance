...
export declare class BoxPlotSeries extends _ModuleSupport.AbstractBarSeries<BoxPlotGroup, BoxPlotSeriesProperties, BoxPlotNodeDatum> {
    ...
    getTooltipContent(nodeDatum: BoxPlotNodeDatum): _ModuleSupport.TooltipContent | string | undefined;
    ...
    protected updateLabelSelection(opts: {
        ...
        seriesIdx: number;
    }): _ModuleSupport.Selection<_ModuleSupport.Text, BoxPlotNodeDatum>;
