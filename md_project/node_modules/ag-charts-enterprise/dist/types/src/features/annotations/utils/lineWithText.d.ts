...
export declare function updateLineText(id: string, line: CollidableLine, textProperties: Partial<LineTextProperties>, coords: _ModuleSupport.Vec4, textNode?: CollidableText, text?: string, lineWidth?: number): {
    clipMask: {
        x: number;
        y: number;
        radius: number;
