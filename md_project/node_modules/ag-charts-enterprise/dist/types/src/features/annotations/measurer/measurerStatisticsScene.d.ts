...
export declare class MeasurerStatisticsScene extends _ModuleSupport.Group {
    ...
    constructor();
    update(datum: MeasurerTypeProperties, stats: Statistics, anchor: _ModuleSupport.Vec2, context: AnnotationContext, verticalDirection?: 'up' | 'down', localeManager?: _ModuleSupport.ModuleContext['localeManager']): void;
