...
export declare class AxisButton extends BaseModuleInstance implements _ModuleSupport.ModuleInstance {
    ...
    private padding;
    private coords?;
    constructor(ctx: _ModuleSupport.ModuleContext, axisCtx: _ModuleSupport.AxisContext, onButtonClick: (coords?: _ModuleSupport.Vec2) => void, seriesRect: _ModuleSupport.BBox);
