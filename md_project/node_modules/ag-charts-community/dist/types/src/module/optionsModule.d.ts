...
export declare class ChartOptions<T extends AgChartOptions = AgChartOptions> {
    ...
    constructor(userOptions: T | ChartOptions<T>, processedOverrides: Partial<T>, specialOverrides: Partial<ChartSpecialOverrides>, metadata: ChartInternalOptionMetadata, deltaOptions?: DeepPartial<T>);
    private fastSetup;
